                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text mt-4 mb-1" style="font-size: 0.8rem;">18h ago - Looking for cash to unlock
                            styles in Azure Latch? Use these codes!</p>
                        <p class="card-text mt-1 text-body-secondary" style="font-size: 0.7rem;">LAUREN HARPER</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h6 class="card-title mt-3" style="font-weight:600;">Codes for SpongeBob Tower Defense (April
                            2025)</h6>
                        <p class="card-text mt-4 mb-1" style="font-size: 0.8rem;">19h ago - Redeem these codes to boost
                            your units and help protect Bikini Bottom!</p>
                        <p class="card-text mt-1 text-body-secondary" style="font-size: 0.7rem;">LAUREN HARPER</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text mt-4 mb-1" style="font-size: 0.8rem;">19h ago - We've got all the codes you
                            need to know for cash, Lucky Spins, and more!</p>
                        <p class="card-text mt-1 text-body-secondary" style="font-size: 0.7rem;">LAUREN HARPER</p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h6 class="card-title mt-3" style="font-weight:600;">Attack on Titan Revolution Codes (April
                            2025)</h6>
                        <p class="card-text mt-4 mb-1" style="font-size: 0.8rem;">21h ago - Redeem these Attack on Titan
                            Revolution codes for extra Spins, Luck Potions, and more.</p>
                        <p class="card-text mt-1 text-body-secondary" style="font-size: 0.7rem;">LAUREN HARPER</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text mt-4 mb-1" style="font-size: 0.8rem;">1d ago - Every Untitled Boxing
                            Game code available to claim this July.</p>
                        <p class="card-text mt-1 text-body-secondary" style="font-size: 0.7rem;">CALLUM
                            WILLIAMS</small>
                        </p>
                    </div>
                </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text mt-4 mb-1" style="font-size: 0.8rem;">1d ago - Boost your SkyBux balance
                            and
                            upgrade your airline with these Cabin Crew Simulator codes.</p>
                        <p class="card-text mt-1 text-body-secondary" style="font-size: 0.7rem;">LAUREN
                            HARPER</small>
                        </p>
                    </div>
                </div>
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text mt-4 mb-1" style="font-size: 0.8rem;">1d ago - Redeem these Blox Fruits
                            codes for double EXP, stat resets, and more!</p>
                        <p class="card-text mt-1 text-body-secondary" style="font-size: 0.7rem;">MEG KOEPP</small>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text mt-4 mb-1" style="font-size: 0.8rem;">1d ago - Use these redeemable
                            Dandy's
                            World codes for a ton of free Ichor!</p>
                        <p class="card-text mt-1 text-body-secondary" style="font-size: 0.7rem;">CALLUM
                            WILLIAMS</small>
                        </p>
                    </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text mt-4 mb-1" style="font-size: 0.8rem;">2d ago - You'll have to pay up.</p>
                        <p class="card-text mt-1 text-body-secondary" style="font-size: 0.7rem;">REBEKAH
                            VALENTINE</small>
                        </p>
                    </div>
                </div>
            ...
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        ...
                        <p class="card-text mt-4 mb-1" style="font-size: 0.8rem;">3d ago - King of the hill.</p>
                        <p class="card-text mt-1 text-body-secondary" style="font-size: 0.7rem;">ERIC VAN ALLEN</small>
                        </p>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h6 class="card-title mt-3" style="font-weight:600;">BAFTA Games Awards 2025: The Full List of
                            Winners</h6>
                        <p class="card-text mt-4 mb-1" style="font-size: 0.8rem;">3d ago - Astro Bot and Still Wakes the
                            Deep the night's biggest winners.</p>
                        <p class="card-text mt-1 text-body-secondary" style="font-size: 0.7rem;">VIKKI BLAKE</small>
                        </p>
                    </div>
                </div>
            </div>
